    ...
    <div class="card">
        ...
        <div class="card-content">
            ...
            <!--        <div class="col-sm-2"><label class="col-form-label"
                    ...
                    </div>  </div>  <div class="row mb-2" style="display:none">


    <div class="col-sm-2"><label class="col-form-label"
                                                 for="width">BarCode Width</label>
               <input name="bar_width" class="form-control required" type="number" value="40">
                    </div>                     <div class="col-sm-2"><label class="col-form-label"
                                                 for="width">BarCode height</label>

                                              <input name="bar_height" class="form-control required" type="number" value="5">
                    </div>  <div class="col-sm-2"><label class="col-form-label"
                    ...
                    </div>  <div class="row mb-2" style="display:none">
   <div class="col-sm-2"><label class="col-form-label"
